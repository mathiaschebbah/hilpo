...
- **Format visuel** : 44 classes (post_news, post_mood, post_selection, post_stills, post_chiffre, post_quote, post_article, post_edito_photo, post_throwback, post_en_savoir_plus_selection, et 34 autres)
